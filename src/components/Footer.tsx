...
const Footer = () => {
  ...
  return (
    <footer id='contacto' className='w-full  lg:h-[400px] bg-[#002337] p-3 flex lg:flex-row flex-col justify-center items-center gap-8'>
      <div className='w-full md:w-1/2 h-1/2 md:h-full flex flex-col justify-center items-center gap-5 order-2 lg:order-1'>
        <FooterIcons />
      </div>
      <div className='md:w-1/2 w-full h-full flex justify-center items-center flex-col order-1 lg:order-2 '>
