...
const Professionals = () => {
  ...
  return (
    <section id='profesionales' className='w-full min-h-screen flex justify-start items-start p-10 flex-col gap-10'>
      <div className='flex justify-center items-center w-full h-1/5 '>
        <h1 className='text-center text-3xl text-[#002337] font-extrabold '>NUESTROS PROFESIONALES</h1>
      </div>
      <div className='w-full flex flex-col gap-24 items-end py-10' >
