...
const ContactForm = () => {
  return (
    <div className='w-full h-full flex justify-center items-start flex-col gap-3'>
      <h1 className='h-1/12 w-full text-start text-3xl text-white font-semibold nunito '>Contactanos</h1>
      <form
        id="miFormulario"
