...
const Header = () => {
  return (
    <header className='w-full h-[85px] hidden lg:flex justify-center items-center bg-[#f3f3f3]'>
      <nav className='w-full h-full hidden lg:flex justify-center items-center'>
